...
export default class HomePage {
  ...
  TODAY_PlUS_7_DAYS =
    '//td[contains(@class, "_12fun97") and contains(@aria-label,"' +
    computeFutureDateFromToday(7) +
    '")]';
  TODAY_PlUS_14_DAYS =
    '//td[contains(@class, "_12fun97") and contains(@aria-label,"' +
    computeFutureDateFromToday(14) +
    '")]';
  ...
  MORE_FILTERS_CHILDREN_BTN =
    '#stepper-children > [aria-label="increase value"]';
  SEARCH_BTN = "._m9v25n";
  ...
  MAIN_ELEMENTS = [this.LOGO];

  visit = () => {
    cy.visit("https://airbnb.com", {
      headers: {
        "user-agent":
